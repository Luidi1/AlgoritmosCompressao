...
const options = {
    definition: {
        ...
        paths: {
            ...
            "/fibonacci-zeckendorf/encode": {
                post: {
                    summary: "Codifica texto usando Fibonacci Zeckendorf",
                    requestBody: {
                        required: true,
                        content: {
                            "application/json": {
                                ...
                                "application/json": {
                                    examples: {
                                        ...
                                        zeroNaoSuportado: {
                                            summary: "Caractere zero não suportado",
                                            value: {
                                                mensagem: "Fibonacci Zeckendorf não suporta o valor 0."
                                            }
                                        }
                                    }
                                }
            ...
            "/fibonacci-zeckendorf/decode": {
                post: {
                    summary: "Decodifica codewords usando Fibonacci Zeckendorf",
                    requestBody: {
                        required: true,
                        content: {
                            "application/json": {
                            ...
                            content: {
                                "application/json": {
                                    examples: {
                                        ...
                                        stopBitInvalido: {
                                            summary: "Stop bit ausente",
                                            value: {
                                                mensagem: "Codeword inválido para Fibonacci Zeckendorf. Falta o stop bit final."
                                            }
                                        },
                                        representacaoInvalida: {
                                            summary: "Representação inválida",
                                            value: {
                                                mensagem: "Codeword inválido para Fibonacci Zeckendorf. Representação inválida."
                                            }
                                        }
                                    }
                                }
